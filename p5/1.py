...
df = pd.read_csv(r'p5\social_capital.csv')
...
def update_graph(dpdn_val):
    if len(dpdn_val) > 0:
        ...
        fig.update_traces(diagonal_visible=False, showupperhalf=True, showlowerhalf=True)   #compare to its self
        fig.update_layout(yaxis1={'title':{'font':{'size':3}}}, yaxis2={'title':{'font':{'size':3}}},
                          yaxis3={'title':{'font':{'size':3}}}, yaxis4={'title':{'font':{'size':3}}},
                          yaxis5={'title':{'font':{'size':3}}}, yaxis6={'title':{'font':{'size':3}}}, #yaxis and xaxis of dataframe
        ...
        # fig.update_layout(xaxis1={'visible':True},yaxis1={'visible':True},yaxis2={'visible':True})
        return False, fig

    if len(dpdn_val)==0:
        return True, dash.no_update # no update at all
