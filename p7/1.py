...
#-------------------------------------------------------
mapbox_access_token = 'pk.eyJ1IjoiaGFtaWRyZXphMDciLCJhIjoiY2w2N2c1azU4MDN4ODNrbnc1eXN3OTl4bCJ9.6NtHlwwWLBMUV_wQcZXUeQ'
...
df = pd.read_csv(r"p7\finalrecycling.csv")
